...
pdf.setTitle("Kidney biopsy rejection classifier")
pdf.setSubject("14 main slides and 6 backup slides. Speaking script is a separate HTML file.")
...
<nav><a href="#valid">Valid public specimen</a><a href="#invalid">Missing IFNG</a><a href="speaking_script.html#slide-11">Speaking script</a></nav></header>
<main><p>Frozen model: <code>20260915_shared:any_rejection:catboost_all_depth4</code><br>
...
<p>The score is below the frozen threshold. Its flag agrees with the recorded no-rejection diagnosis.</p>
...
<img src="{image('demo-invalid.png')}" alt="Actual local application reporting Missing required assay targets: IFNG and showing no prediction"></section></main></html>''', encoding="utf-8")
print("Created matching 20-page PDF and offline demonstration capture page")
