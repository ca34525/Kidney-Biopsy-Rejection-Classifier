...
<nav><a href="#valid">Valid public specimen</a><a href="#invalid">Missing IFNG</a><a href="speaking_script.html#{demo_anchor}">Speaking script</a></nav></header>
