...
- Slide 15 should clearly introduce the prediction service and demonstration. Present slide 18 as possible extensions of a personal project. On slide 19, separate the model comparison from the service/demo, show percentages with denominators, and close on completed work without another next-step bullet.
