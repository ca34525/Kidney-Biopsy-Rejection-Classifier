...
presentation figures, and small consistency fixes. Slides and rehearsal remain
required delivery work.

## Short version for a slide

1. **Does the comparison hold in an independent, assay-compatible cohort?**
2. **Do assay quality, processing groups, or viral targets change the conclusion?**
3. **Can discovery-fitted calibration improve score interpretation?**
...
rules and evaluation procedure before inspecting its results. A compatible new
...
### 2. Assay and feature sensitivity
