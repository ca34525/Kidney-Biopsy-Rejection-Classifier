...
Source run: `results/reproduction/20260922_mac_clone`. Analysis seed: 20260915. Target: any recorded rejection in an already collected biopsy.
...
The local specimen review is `data/processed/analysis/20260922_mac_clone/specimen_review.csv`; `selected_model_errors.csv` contains only the selected model's errors. They retain original diagnosis, assay date/cartridge/scanner, all model scores and decisions, and outcome categories. Per-specimen files are Git-ignored.
...
The original source study included 1,193 transplant biopsies and 202 native-kidney controls. Its 345-specimen technical-validation cohort included 334 transplant biopsies and 11 native-kidney controls. These published totals describe the source cohorts; the public metadata do not identify individual native-kidney specimens. See the [September 19, 2026 source review](../../../docs/references/STUDY_AUDIT_20260919.md).
